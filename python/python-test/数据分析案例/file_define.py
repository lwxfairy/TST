...
if __name__ == '__main__':
    text_file_reader = TextFileReader("D:/python/python-test/2011年1月销售数据.txt")
    json_file_reader = jsonFileReader("D:/python/python-test/2011年2月销售数据JSON.txt")
